// document.addEventListener('DOMContentLoaded', () => {
  ...
  // for (let i = 0; i < rating_stars.length; i++) {
    // rating_stars[i].addEventListener('click', function () {
      ...
      //   document.querySelector('#' + this.id).classList.remove('fas');
      //   document.querySelector('#' + this.id).classList.add('far');
      // };
      ...
      // console.log(document.querySelectorAll('.rating-stars'));
      // console.log(typeof(document.querySelectorAll('.rating-stars')));
      // console.log(document.querySelectorAll('.rating-stars')[0]);
      // console.log(Array.from(document.querySelectorAll('.rating-stars')).filter(star => star.dataset.rating > 3));
